...
class PostProcView(APIView):
    ...
    def order(self, options):
        ...
        * options: [
        ...
        preferencia).
        - Entrada: votos totales por cada eleccion (es decir, la suma total de los puestos obtenidos por cada
        opción en las votaciones, de forma que las opciones con menos votos serán las que obtuvieran
